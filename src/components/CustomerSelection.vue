  ...
  <div class="p-6 flex flex-col items-center">
    <div class="w-full max-w-md relative">
      ...
      <div v-if="selected" class="mt-4 p-4 bg-white rounded-lg">
        ...
        <div class="text-gray-700 gap-20 space-y-3">
          <p class="flex items-center">
            <i class="fas fa-user mr-2 text-green-500"></i> <strong>Name:</strong> {{ selected.customer_name }}
          </p>
          <p class="flex items-center">
            <i class="fas fa-envelope mr-2 text-yellow-500"></i> <strong>Email:</strong> {{ selected.email }}
          </p>
          <p class="flex items-center">
            <i class="fas fa-phone mr-2 text-blue-500"></i> <strong>Phone:</strong> {{ selected.phone }}
          </p>
          <p class="flex items-center">
            <i class="fas fa-map-marker-alt mr-2 text-red-500"></i> <strong>Address:</strong> {{ selected.address }}
          </p>
        </div>
      </div>
    </div>
